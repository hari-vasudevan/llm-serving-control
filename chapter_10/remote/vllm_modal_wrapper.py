#!/usr/bin/env python3
"""
Chapter 10 Modal vLLM admission and measurement wrapper.

This file starts from the Chapter 8 wrapper queue server. In Chapter 10 it
will be reshaped into an experimental admission layer for measuring how
external queue-wait targets affect vLLM/Qwen latency, throughput, and GPU
power.
...
def prom_metrics_text():
    ...
    gauges = {
        "ch10_q_sw": m["q_sw"],
        "ch10_q_mean_tick": m["q_mean_tick"],
        "ch10_q_max_tick": m["q_max_tick"],
        "ch10_B_current": m["B_current"],
        "ch10_lambda_10s_est": m["lambda_10s_est"],
        "ch10_lambda_tick": m["lambda_tick"],
        "ch10_arrivals_tick": m["arrivals_tick"],
        "ch10_completions_tick": m["completions_tick"],
        "ch10_service_rate_tick": m["service_rate_tick"],
        "ch10_l_mean_ms": m["l_mean_ms"] or 0,
        "ch10_ttft_mean_ms": m["ttft_mean_ms"] or 0,
        "ch10_queue_wait_mean_ms": m["queue_wait_mean_ms"] or 0,
        "ch10_vllm_num_requests_waiting": m["vllm_num_requests_waiting"] or 0,
        "ch10_vllm_num_requests_running": m["vllm_num_requests_running"] or 0,
    }
...
def main():
    ...
    parser.add_argument("--trace-prefix", default="CH10")
