...
DT = perturbed.dt;
SEGMENTS = struct( ...
    'ticks', {30, 20, 25, 20, 25}, ...
    'lambda', {perturbed.lambda_mean, perturbed.lambda_mean * 1.35, perturbed.lambda_mean * 0.8, perturbed.lambda_mean * 1.55, perturbed.lambda_mean}, ...
...
for si = 1:numel(SEGMENTS)
    ...
    for sk = 1:seg.ticks
        ...
        B_unsat = controller.inner_c.B0 - controller.inner_c.K_q * (q - controller.outer_c.q0) ...
